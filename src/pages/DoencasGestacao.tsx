...
export default function DoencasGestacao() {
  ...
  const [selectedDisease, setSelectedDisease] = useState<typeof mockGestacaoDiseases[0] | null>(null);
  ...
  const openDiseaseModal = (disease: typeof mockGestacaoDiseases[0]) => {
                      ...
                      <CardHeader className="pb-4">
                        <div className="flex items-start justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            >
                              <Heart 
                                className={`w-4 h-4 ${disease.isFavorite ? 'fill-purple-600 text-purple-600' : 'text-purple-600'}`} 
                              />
                            </Button>
