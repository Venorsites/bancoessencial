                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      <Badge 
                        ...
                        className="text-sm rounded-lg"
                      >
                        Consulte um profissional de saúde especializado em aromaterapia pediátrica
                      </Badge>
                      <Badge 
                        variant="secondary" 
                        className="text-sm rounded-lg"
                      >
                        Dosagens variam conforme a idade da criança
                      </Badge>
                      <Badge 
                        variant="secondary" 
                        className="text-sm rounded-lg"
                      >
                        Sempre supervisionadas por um adulto
                      </Badge>
                    </div>
                  </div>
